...
public class Adder {
     ...
     * @see VehiclesCollection#updateFromDB()
     * @param vehicle добавляемый элемент  */
    public static void vehicleAdderToDB(Vehicle vehicle) {
        ConnectionToBase.executeStatement("insert into vehicle (id, creator, creationDate, name, enginePower, capacity, fuelConsumption, type, x, y) values ('" + vehicle.getId() + "', '" + vehicle.getCreator() + "', '" + vehicle.get() + "', '" + vehicle.getName() + "', '" + vehicle.getEnginePower() + "', '" + vehicle.getCapacity() + "', '" + vehicle.getFuelConsumption() + "', '" + vehicle.getType() + "', '"  + vehicle.getCoordinates().getX() + "', '" + vehicle.getCoordinates().getY() + "')");
